...
public abstract class AbstractCmsProcessor implements CmsProcessor {
    ...
    protected final CmsConfigurer cmsConfigurer;

    public AbstractCmsProcessor(CmsConfigurer cmsConfigurer) {
    ...
    protected Map<String, Map<String, String>> getGroupedCmsResultsSubMap(Map<String, String> results, String prefix) {
        ...
        results.entrySet()
                ...
                .forEach(entry -> {
                    ...
                    final String[] keyParts = entryKey.split(String.valueOf(cmsConfigurer.getPropertySeparator()), 2);
